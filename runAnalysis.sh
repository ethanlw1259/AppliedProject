...
plink --logistic --allow-no-sex  --bfile ${inputBed} --pheno ${phenoFile} --covar ${covarFile} --hide-covar --out  ${outputFile}
plink --model  --allow-no-sex --bfile ${inputBed} --pheno ${phenoFile} --covar ${covarFile} --hide-covar --out  ${outputFile}
